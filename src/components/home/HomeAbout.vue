<template>
  <section class="about" id="section2" ref="about">
    ...
    <div class="about__main" ref="aboutMain">
      ...
      <svg ref="aboutShapes" class="about__back1" width="960" height="732" viewBox="0 0 960 732" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <svg ref="aboutNumber" class="about__back2" width="263" height="219" viewBox="0 0 263 219" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  watch: {
    homeSlide (homeSlide, prevHomeSlide) {
      ...
      if (prevHomeSlide === 2) {
        ...
        gsap.to(this.$refs.aboutTitle, { opacity: 0, y: 100, duration: 0, delay: 1 })
        gsap.to(this.$refs.aboutText, { opacity: 0, y: 100, duration: 0, delay: 1 })
        gsap.to(this.$refs.aboutShapes, { opacity: 0, x: 100, duration: 0, delay: 1 })
        gsap.to(this.$refs.aboutNumber, { opacity: 0, x: 100, duration: 0, delay: 1 })
      }
    }
  },
  mounted () {
    ...
    gsap.to(this.$refs.aboutTitle, { opacity: 0, y: 100, duration: 0 })
    gsap.to(this.$refs.aboutText, { opacity: 0, y: 100, duration: 0 })
    gsap.to(this.$refs.aboutShapes, { opacity: 0, x: 100, duration: 0 })
    gsap.to(this.$refs.aboutNumber, { opacity: 0, x: 100, duration: 0 })
  }
}
</script>
