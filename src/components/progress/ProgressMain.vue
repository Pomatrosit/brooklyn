  ...
  <section class="progress">
    <div class="app-wrapper">
      <div class="progress__img">
        <img src="/img/mainPage/homeAboutBg.png" alt="progress">
      </div>
      <div class="progress__main">
        ...
        <div class="text-block">
          <svg class="text-block__bg" width="836" height="710" viewBox="0 0 836 710" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div class="text-block__content">
            <h2 class="text-block__title">Декабрь 2020</h2>
            <ul class="text-block__list">
              <li class="text-block__item">Продолжаем монтаж системы электроснабжения, вентиляции, водоснабжения и водоотведения.</li>
              <li class="text-block__item">Выполняем устройство слаботочных сетей. Идут работы черновой отделки. Монтируем витражи и окна.</li>
              <li class="text-block__item">Выполняем монолитные работы рампы паркинга и устройство гидроизоляции плиты паркинга.</li>
              <li class="text-block__item">Продолжаем фасадные работы. Приступаем к благоустройству территории.</li>
            </ul>
          </div>
        </div>
        <div class="slider-nav">
          <div class="slider-nav__prev">
            <p class="slider-nav__text">Февраль 2021</p>
            <img src="/img/mainPage/swooshed/4.jpg" alt="">
          </div>
          <div class="slider-nav__next">
            <p class="slider-nav__text">Март 2021</p>
            <img src="/img/mainPage/swooshed/5.jpg" alt="">
          </div>
        </div>
        <div class="mouse">
          ...
          <svg width="4.8vh" height="1.15vh" viewBox="0 0 46 11" fill="none" xmlns="http://www.w3.org/2000/svg">
