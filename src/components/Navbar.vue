  ...
  <nav>
    <div class="app-wrapper">
      <div class="nav__main">
        ...
        <ul class="nav__links">
          <li>
            <router-link to="/apartments/visual"
              ><a class="nav-hovered" :class="{ activeLink: page === 1 }"
                >Выбор квартиры</a
              ></router-link
            >
          </li>
          <li>
            <router-link to="/gallery"
              ><a class="nav-hovered" :class="{ activeLink: page === 2 }"
                >Галерея</a
              ></router-link
            >
          </li>
          <li>
            <router-link to="/news"
              ><a class="nav-hovered" :class="{ activeLink: page === 3 }"
                >Новости</a
              ></router-link
            >
          </li>
          <li>
            <router-link to="/progress"
              ><a class="nav-hovered" :class="{ activeLink: page === 4 }"
                >Ход строительства</a
              ></router-link
            >
          </li>
          <li>
            <router-link to="/contacts"
              ><a class="nav-hovered" :class="{ activeLink: page === 5 }"
                >Контакты</a
              ></router-link
            >
          </li>
        </ul>
        <div class="nav__camera" @click="goToCameraPage">
          <svg
            width="34"
            height="26"
            viewBox="0 0 34 26"
...
export default {
  ...
  computed: {
    ...
    phone() {
      return this.$store.getters.allInfo[0].phone;
    }
  },
  data: () => ({
    path: "/"
